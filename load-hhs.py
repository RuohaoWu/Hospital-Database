...
# Make a new dataframe named exception_df
# To capture the exception may occur when we load the data
# This data frame only contains one column named Exception
